...
namespace sintaxe_em_c_.Models.PessoaCopia //eu posso ter várias cópias da minha classe, desde que o namespace seja diferente, fazendo a devido referência usando o (using) <- que aponta para o caminho
{
